...
<div class="w-event-meta">	
			...
			<div class="tribe-events-meta-group tribe-events-meta-group-venue">
				<h3 class="tribe-events-single-section-title"> <?php esc_html_e( 'Location', 'tribe-events-calendar' ) ?> </h3>
				<dl>
					...
					?>
					<?php if ( ! empty( $phone ) ): ?>
						<h3> <?php esc_html_e( 'Phone', 'tribe-events-calendar' ) ?> </h3>
						<dd class="tel"> <?php echo $phone ?> </dd>
					<?php endif ?>
					<?php if ( ! empty( $website ) ): ?>
						<h3> <?php esc_html_e( 'Website', 'tribe-events-calendar' ) ?> </h3>
			...
			<div class="event-sharing">
				<h3><?php esc_html_e('Share this Event','webnus_framework'); ?></h3>
				<ul class="event-social">
						...
						<li><a class="twitter" href="https://twitter.com/intent/tweet?original_referer=<?php echo $permalink ;?>&amp;text=<?php the_title(); ?>&amp;tw_p=tweetbutton&amp;url=<?php echo $permalink ;?><?php echo isset( $twitter_user ) ? '&amp;via='.$twitter_user : ''; ?>" target="_blank"><i class="fa-twitter"></i></a>
				</ul>
			</div>
