...
if(function_exists('wp_pagenavi')) { wp_pagenavi(); } else {
	...
	next_posts_link(esc_html__('&larr; Previous page', 'webnus_framwork'));
	previous_posts_link(esc_html__('Next page &rarr;', 'webnus_framwork'));
