...
function webnus_theme_setup() {
	...
	add_action('admin_bar_menu', 'webnus_admin_bar_link',25);
			...
			$item_output .= '<ul class="sub-posts">';			
				...
				foreach( $menuposts as $post ):
					...
					if ( $post_image != ''){
						...
						$menu_post_image = esc_html__( 'No image','WEBNUS_TEXTDOMAIN');
					}
					$item_output .= '
							<li>
								<figure>
...
// Add Base64 to Backend
    wp_enqueue_script('base64', get_template_directory_uri() . '/js/base64.js', null, null, true);

// IconFonts Style
	wp_enqueue_style('iconfonts-style', get_template_directory_uri() . '/inc/iconfonts/style.css', null, null);
	wp_enqueue_style('iconfonts-style-gen', get_template_directory_uri() . '/inc/iconfonts/custom.css', null, null);
...
function webnus_admin_bar_link() {
	global $wp_admin_bar;
	if ( !is_super_admin() || !is_admin_bar_showing() )
		return;
	$wp_admin_bar->add_menu( array(
	'id' => 'webnus_themeoption_link',
	'title' => esc_html__( 'Webnus Theme Option','webnus_framework'),
