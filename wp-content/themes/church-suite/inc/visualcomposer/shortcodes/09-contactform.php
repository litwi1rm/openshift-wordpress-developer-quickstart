...
vc_map( array(
    ...
    'params' => array(
		...
		array(
			...
			'value'			=> '',
			'description'	=> wp_kses( __( 'Which email would you like the contacts to be sent, if left empty the information will be sent to Admin email address <span style="color:#FF932E;">"' . get_option( 'admin_email' ) . '"</span> by default.', 'webnus_framework'), array( 'span' => array( 'style' => array() ), 'br' => array() ) ),
		),
