...
vc_map( array(
        ...
        'params' => array(
			...
			array(
				...
				'param_name' => 'post',
				'value'=>'',
				'description' => esc_html__( 'Pick up the ID & fallow this instruction: admin panel > sermons > ID column. Note: When you type nothing it puts latest sermon as default to show.', 'webnus_framework'),
