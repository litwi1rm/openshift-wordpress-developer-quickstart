...
if ( ! class_exists('NHP_Options') ){
	...
	if(!defined('NHP_OPTIONS_URL')){
		...
		// define('NHP_OPTIONS_URL', "https://stannes-ryanlitwiller.rhcloud.com/wp-content/themes/church-suite/inc/nc-options/options/");
	}
...
class NHP_Options{
	...
	*/
	function __construct($sections = array(), $args = array(), $extra_tabs = array()){
		...
		$defaults['footer_credit'] = wp_kses( __('<span id="footer-thankyou">Webnus web development group. Visit us on <a href="http://themeforest.net/user/WEBNUS/" target="_blank">Themeforest</a>  </span>', 'nhp-opts'), array( 'span' => array( 'id' => array() ), 'a' => array( 'href' => array(), 'target' => array() ) ) );
	...
	function _options_page(){
		...
		if(true === $this->args['allow_sub_menu']){
			...
			if(true === $this->args['show_import_export']){
				...
				add_submenu_page(
						$this->args['page_slug'],
						esc_html__('Import / Export', 'nhp-opts'),
						esc_html__('Import / Export', 'nhp-opts'),
						$this->args['page_cap'],
			...
			if(true === $this->args['dev_mode']){
				...
				add_submenu_page(
						$this->args['page_slug'],
						esc_html__('Dev Mode Info', 'nhp-opts'),
						esc_html__('Dev Mode Info', 'nhp-opts'),
						$this->args['page_cap'],
						...
						echo '<div id="import_export_default_section_group'.'" class="nhp-opts-group-tab">';
							...
							echo '<div id="nhp-opts-import-link-wrapper">';
								...
								echo '<select id="import-link-value" name="'.$this->args['opt_name'].'[import_link]">
											<option value="'.get_template_directory_uri() . '/inc/dummy-data/remittal.txt">Remittal</option>
											<option value="'.get_template_directory_uri() . '/inc/dummy-data/pax.txt">Pax</option>
											<option value="'.get_template_directory_uri() . '/inc/dummy-data/solace.txt">Solace</option>
											<option value="'.get_template_directory_uri() . '/inc/dummy-data/trust.txt">Trust</option>
										</select>';
