...
if (!class_exists('webnus_options')) {
	class webnus_options {
		...
		function webnus_booking_enable() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_booking_enable']) ? $thm_options['webnus_booking_enable'] : null;
		}
		function webnus_booking_form() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_booking_form']) ? $thm_options['webnus_booking_form'] : null;
		}
		function webnus_singlesermon_sidebar() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_singlesermon_sidebar']) ? $thm_options['webnus_singlesermon_sidebar'] : null;
		}
		function webnus_sermon_speaker() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_sermon_speaker']) ? $thm_options['webnus_sermon_speaker'] : null;
		}		
		function webnus_sermon_date() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_sermon_date']) ? $thm_options['webnus_sermon_date'] : null;
		}		
		function webnus_sermon_category() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_sermon_category']) ? $thm_options['webnus_sermon_category'] : null;
		}		
		function webnus_sermon_comments() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_sermon_comments']) ? $thm_options['webnus_sermon_comments'] : null;
		}		
		function webnus_sermon_views() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_sermon_views']) ? $thm_options['webnus_sermon_views'] : null;
		}		
		function webnus_sermon_featuredimage() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_sermon_featuredimage']) ? $thm_options['webnus_sermon_featuredimage'] : null;
		}		
		function webnus_sermon_social_share() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_sermon_social_share']) ? $thm_options['webnus_sermon_social_share'] : null;
		}
		function webnus_sermon_speakerbox() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_sermon_speakerbox']) ? $thm_options['webnus_sermon_speakerbox'] : null;
		}			
		function webnus_recent_sermons() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_recent_sermons']) ? $thm_options['webnus_recent_sermons'] : null;
		}	
		function webnus_singlecause_sidebar() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_singlecause_sidebar']) ? $thm_options['webnus_singlecause_sidebar'] : null;
		}
		function webnus_donate_form() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_donate_form']) ? $thm_options['webnus_donate_form'] : null;
		}
		function webnus_cause_currency() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_cause_currency']) ? $thm_options['webnus_cause_currency'] : '$';
		}
		function webnus_cause_date() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_cause_date']) ? $thm_options['webnus_cause_date'] : null;
		}		
		function webnus_cause_category() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_cause_category']) ? $thm_options['webnus_cause_category'] : null;
		}		
		function webnus_cause_comments() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_cause_comments']) ? $thm_options['webnus_cause_comments'] : null;
		}		
		function webnus_cause_views() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_cause_views']) ? $thm_options['webnus_cause_views'] : null;
		}		
		function webnus_cause_featuredimage() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_cause_featuredimage']) ? $thm_options['webnus_cause_featuredimage'] : null;
		}		
		function webnus_cause_social_share() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_cause_social_share']) ? $thm_options['webnus_cause_social_share'] : null;
		}		
		...
		function webnus_topbar_fixed() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_fixed']) ? $thm_options['webnus_topbar_fixed'] : null;
		}
		
		function webnus_topbar_search() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_search']) ? $thm_options['webnus_topbar_search'] : null;
		}


		function webnus_topbar_social() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_social']) ? $thm_options['webnus_topbar_social'] : null;
		}
		
		function webnus_topbar_login() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_login']) ? $thm_options['webnus_topbar_login'] : null;
		}
		
		function webnus_topbar_login_text() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_login_text']) ? $thm_options['webnus_topbar_login_text'] : 'LOGIN';
		}
		
		function webnus_topbar_donate() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_donate']) ? $thm_options['webnus_topbar_donate'] : null;
		}
		
		function webnus_topbar_contact() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_contact']) ? $thm_options['webnus_topbar_contact'] : null;
		}

		function webnus_topbar_form() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_form']) ? $thm_options['webnus_topbar_form'] : null;
		}
		
		function webnus_topbar_info() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_info']) ? $thm_options['webnus_topbar_info'] : null;
		}
		
		function webnus_topbar_menu() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_menu']) ? $thm_options['webnus_topbar_menu'] : null;
		}
		
		function webnus_topbar_custom() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_custom']) ? $thm_options['webnus_topbar_custom'] : null;
		}
		
		function webnus_topbar_text() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_text']) ? $thm_options['webnus_topbar_text'] : null;
		}
		
		function webnus_topbar_language() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_language']) ? $thm_options['webnus_topbar_language'] : null;
		}
		...
		function webnus_topbar_email() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_email']) ? $thm_options['webnus_topbar_email'] : null;
		}
		
		function webnus_topbar_phone() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_topbar_phone']) ? $thm_options['webnus_topbar_phone'] : null;
		}
		...
		function webnus_dark_submenu() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_dark_submenu']) ? $thm_options['webnus_dark_submenu'] : 1;
		}
				
		function webnus_header_background() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_header_background']) ? $thm_options['webnus_header_background'] : 1;
		}
		...
		function webnus_no_image() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_no_image']) ? $thm_options['webnus_no_image'] : null;
		}

		function webnus_no_image_src() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_no_image_src']) ? $thm_options['webnus_no_image_src'] : null;
		}
		...
		function webnus_recommended_posts() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_recommended_posts']) ? $thm_options['webnus_recommended_posts'] : 1;
		}
		...
		function webnus_blog_excerpt_large() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_blog_excerpt_large']) ? $thm_options['webnus_blog_excerpt_large'] : null;
		}
		
		function webnus_blog_excerpt_list() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_blog_excerpt_list']) ? $thm_options['webnus_blog_excerpt_list'] : null;
		}
		...
		function webnus_footer_mailchimp_url() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_footer_mailchimp_url']) ? $thm_options['webnus_footer_mailchimp_url'] : null;
		}
		function webnus_footer_subscribe_type() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_footer_subscribe_type']) ? $thm_options['webnus_footer_subscribe_type'] : null;
		}
		...
		function webnus_woo_sidebar_enable() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_woo_sidebar_enable']) ? $thm_options['webnus_woo_sidebar_enable'] : 1;
		}
