...
extract(shortcode_atts(	array(
	...
	//terms		
		...
		$sermon_video = (array_key_exists('sermon_video',$w_sermon_meta))?'<a href="'.$w_sermon_meta['sermon_video'].'" class="videolb '.$button.'" target="_self"><i class="fa-play-circle"></i>'.esc_html__('WATCH','webnus_framework').'</a>':'';
