...
if(!class_exists('webnus_importer_class'))
{
	class webnus_importer_class{
				...
				<div class="">
					<div class="webnus-importer-header">
						...
						<table class="form-table">
							<tbody>
							<tr valign="middle">
								<td scope="row" width="150"><?php esc_html_e('Import', 'webnus_framework'); ?></td>
								<td>
							...
							<tr valign="middle">
								<td scope="row" width="150"><?php esc_html_e('Import Widgets', 'webnus_framework'); ?></td>
								<td>
							...
							<tr valign="middle">
								<td scope="row" width="150"><?php esc_html_e('Import Menu Setting', 'webnus_framework'); ?></td>
								<td>
							...
							<tr valign="middle">
								<td scope="row" width="150"><?php esc_html_e('Import Reading Settings', 'webnus_framework'); ?></td>
								<td>
							...
							<tr class="loading-row"><td></td><td><div class="import_load"><span><?php esc_html_e('The import process may take some time. Please be patient.', 'webnus_framework') ?> </span><br />
							...
							<tr><td colspan="2">
									<?php esc_html_e('Important notes:', 'webnus_framework') ?><br />
									- <?php esc_html_e('Please note that import process will take time needed to download all attachments from demo web site.', 'webnus_framework'); ?><br />
									- <?php esc_html_e('If you plan to use shop, please install WooCommerce before you run import.', 'webnus_framework') ?>
								</td></tr>
		...
		function import_reading_settings(){
			...
			$home = get_page_by_title( 'Home 1 - Remittal' );
			if(!empty($home))
			{
