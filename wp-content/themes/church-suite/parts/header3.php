...
<?php
	...
	$header_background = ($webnus_options->webnus_header_background())? 'style="background-size:cover; background-image: url(\''.$webnus_options->webnus_header_background().'\')"':'';
	$menu_icon = ($webnus_options->webnus_header_menu_icon())? 'sm-rgt-mn ':'';
?>
	<header id="header" <?php echo $header_background; ?> class="vertical-w <?php echo $menu_icon ;?>">
